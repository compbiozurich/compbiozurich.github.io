...
**Abstract** We present the first comprehensive evaluation of the 10x Genomics Xenium platform at the Functional Genomics Center Zurich (FGCZ) since its installation in June 2024. We assess the platform's capabilities and limitations across multiple projects. Our analysis focuses on critical aspects of the spatial transcriptomics workflow, including multi-modal cell segmentation, quality control metrics, and data processing challenges. Through various case studies, we demonstrate how tissue quality and preparation significantly impact analysis outcomes.<!--more-->
